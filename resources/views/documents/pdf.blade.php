                                    ...
                                    <table class="border-collapse border-spacing-0">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="pl-4">
                                                    <div>
                                                        <p class="whitespace-nowrap text-slate-400 text-right">{{ $document->document_type }} #</p>
                ...
                <table class="w-full border-collapse border-spacing-0">
                    ...
                    @foreach($document->items as $item)
                        <tr>
                            ...
                            <td class="border-b py-3 pl-2">{{ $item->item_name }}</td>
                            ...
                            <td class="border-b py-3 pl-2 pr-3 text-right">{{ $item->subtotal }}</td>
                        </tr>
